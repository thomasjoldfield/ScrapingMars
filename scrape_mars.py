#this will create a function, scrape(), that pulls information from the web.
...
def scrape():
    ...
    #grab that image
    image_ext = image_soup.find('img', class_= "fancybox-image")['src']
    ...
    mars_complete = {}
    mars_complete["mars_news"] = mars_news
    mars_complete["mars_image"] = image_dict
    mars_complete["mars_weather"] = mars_weather_dict
    mars_complete["mars_facts"] = mars_facts
    mars_complete["mars_hemispheres"] = hemisphere_image_urls
    #{"mars_news":mars_news, "mars_image":image_dict, "mars_weather":mars_weather_dict, "mars_facts":mars_facts, "mars_hemispheres":hemisphere_image_urls}

    return(mars_complete)